(function(){
	var manifest = {
			domain:'mathbiol',
			name:'mathbiol.countshapes',
			display:'Count Shapes',
			description:'Count annotataed shapes with anotation done by mathbiol.chromomarkers.',
			url:'',	//url to module file
			key:'',	//Meant for future use
			version:'0.1.0',
			author:'Jonas Almeida',
			credits:'Bade Iriabho',
			requires:['modules/mathbiol.chromomarkers.js']
		};
	...
	var menu={
			New:imagejs.callFunction(manifest.name,'start'),
